...
import 'package:rest_api2/model.dart';
                  ...
                  return Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          getText(
                              index, 'Website: ', userDetails[index].website.toString()),
                          getText(
                              index, 'Company Name: ', userDetails[index].company.toString()),
                          getText(
                              index, 'Address: ', '${userDetails[index].address.suite.toString()}, ${userDetails[index].address.street.toString()} - ${userDetails[index].address.zipcode.toString()}'),
                        ]),
                  );
                });
          } else {
